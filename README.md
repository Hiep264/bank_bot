...
3. Lưu message user vào bảng messages với 
ole='user'.
...
- Summary được tạo trong pp/services/summary_service.py.
...
- Supabase dùng 2 bảng chính:
  ...
  - messages: lưu các tin nhắn với conversation_id, 
ole, content, message_order.
...
- Summary tự động cập nhật theo SUMMARY_INTERVAL = 6 trong pp/api/chat.py.
- pp/services/llm_service.py sử dụng HTTP API của LLM và chèn summary vào prompt nếu có.
- pp/services/summary_service.py dùng Google Gemini qua google.generativeai để tạo bản tóm tắt.
